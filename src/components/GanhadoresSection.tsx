    ...
    <section id="ganhadores" className="mb-16">
      ...
      {ganhadores.length === 0 ? (
        <p className="text-sm text-zinc-500">
          Ainda não tivemos nenhum ganhador cadastrado. Assim que a primeira
          rifa for concluída, os ganhadores aparecerão aqui automaticamente.
        </p>
      ) : (
